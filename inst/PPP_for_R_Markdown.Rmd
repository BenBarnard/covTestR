...
$$\boldsymbol{A}_i = \boldsymbol{X}_i\boldsymbol{X}_i^T \quad \quad \boldsymbol{D}_i = diag \left(  a_{ij}\right)$$
<div class = "notes">
If the numerator for the sample covariance for our data is the matrix x i transpose times x i then A i is xi times x i transpose. D i is the diagonalization of the elements of the matrix A i. 
</div>
