...
- Our sample covariance matrices, $\boldsymbol{S}_1, \ldots \boldsymbol{S}_k$, are distributed $(n_i - 1) \boldsymbol{S}_i \sim W_p(\boldsymbol{\Sigma}_i, n_i - 1)$. 
...
$$M = (n - k) \log |\boldsymbol{S}| - \sum \limits^k_{i=1} (n_i - 1) \log |\boldsymbol{S}_i| \xrightarrow{d} \chi^2$$
...
- The $a_{ji}$ terms are consistent estimators of $\frac{tr\left( \boldsymbol{\Sigma}_i^j\right)}{p}$.
...
- Let $\widehat{\boldsymbol{M}}$ represent the scatter matrix of $\boldsymbol{X}$
...
$$
  ...
  1 & .5 & .25 & .125 & \ldots & \approx 0\\
  .5 & \ddots& \ddots & .25 & \ddots & \vdots\\
  .25 & \ddots & \ddots& .5 & \ddots & .125\\
  .125 & .25 & .5 & 1 & \ddots & .25 \\
  \vdots & \ddots & \ddots & \ddots & \ddots & .5 \\
  \approx 0 & \ldots & .125 & .25 & .5 & 1
  \end{bmatrix}.
  $$
<div class = "notes">
...
## Toeplitz Covariance at a Frobenius Norm of 0.02
...
## Toeplitz Covariance at a Frobenius Norm of 0.04
...
## Spiked Covariance at a Frobenius Norm of 1.9
...
- We saw some improvements in power with dimension reduction.
...
- Explore further some of the asymptotic properties of the tests.

- Why does the Data Scatter dimension reduction method appear to do better than the covariance differences method?

- Look at a another nontrivial k $(k \neq 3)$ group situation.

- See how shrinkage estimators perform with these tests.

- Look at one sample high dimensional tests.

<div class = "notes">
Explore further some of the asymptotic properties of the tests. Why does the Data Scatter dimension reduction method appear to do better than the covariance differences method? Look at a another nontrivial k $(k \neq 3)$ group situation. See how shrinkage estimators perform with these tests. Looking at one sample high dimensional tests.
</div>
